...
Permitir inclusões, edições e remover nos agendamentos, assim como save dos dados por usuário.

Permitir inclusões dos filmes na lista.

Garantir a lista de posts/usuários fique legível e alinhada.

Estilizar os botões de "Editar" e "Remover" para que fiquem intuitivos.

Garantir que o formulário de adicionar novos itens não quebre o layout da tela.
